...
def axis_sobel(r, g, b, im_size : tuple[int, int], mask : np.ndarray, mask_size : tuple[int, int], stride : int, activation_function : str, *, a = None) -> np.ndarray:
    im_sobel_ver = correlation(r, g, b, im_size, mask, mask_size, stride, activation_function, a=a)

    return im_sobel_ver

def full_axis_sobel(r, g, b, im_size : tuple[int, int], mask : np.ndarray, mask_size : tuple[int, int], stride : int, activation_function : str, *, a = None) -> Image.Image:
    arr_im_sobel_ver = correlation(r, g, b, im_size, mask, mask_size, stride, activation_function, a=a)
    im_sobel_ver = histogram_exp(arr_im_sobel_ver)

    return im_sobel_ver

def sobel(r, g, b, im_size : tuple[int, int], mask : np.ndarray, mask_size : tuple[int, int], stride : int, activation_function : str, *, a = None) -> Image.Image:
